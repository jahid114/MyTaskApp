  ...
  return (
    <main className='home'>
      ...
      <div className='home_container'>
        ...
        <div className='home_container_top' style={{ backgroundColor: theme ? '#282834' : '#ececec' }}>
          ...
          {showForm && (
            <form className='home_form_container' onSubmit={handleSubmitNote}>
              <div className='home_input_container'>
                ...
                <button className='form_add_more'>{isEditing ? 'Update' : 'Create'}</button>
              </div>
              {addMore && (
                <textarea
                  type='text'
              ...
              return userNotes.length > 0 ? (
                <div key={dateStr}>
                  <div className='note_row'>
                    <h2 style={{ backgroundColor: theme ? '#282834' : '#e6e6e6' }} className='note_row_title'>
